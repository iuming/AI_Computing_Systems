...
// TODO(mashengtao) use this struct to replace conv, pad,.. params
...
struct MLUYolov3DetectionOutputOpParam {
  ...
  MLUYolov3DetectionOutputOpParam(int batchNum, int inputNum, int classNum,
                                  int maskGroupNum, int maxBoxNum, int netw,
                                  int neth, float confidence_thresh,
                                  float nms_thresh, int* inputWs, int* inputHs,
                                  float* biases)
      : batchNum_(batchNum),
        inputNum_(inputNum),
        classNum_(classNum),
