...
export PATH_TFVENV_GPU=${WORKSPACE}/virtualenv_gpu

#export PYTHON_BIN_PATH=$(which python || which python3  || true)
#export PYTHON_LIB_PATH="/usr/local/lib/python2.7/dist-packages"
export PYTHON_BIN_PATH=${PATH_TFVENV_GPU}/bin/python
export PYTHON_LIB_PATH=${PATH_TFVENV_GPU}/lib/python2.7/site-packages
...
echo "=== config  ============================================================="
[ ! -e ${PATH_TFVENV_GPU} ] && virtualenv --system-site-packages ${PATH_TFVENV_GPU}
source ${PATH_TFVENV_GPU}/bin/activate
...
bazel-bin/tensorflow/tools/pip_package/build_pip_package ${PATH_TFVENV_GPU} --gpu

# Upgrade the whl package
pip install ${PATH_TFVENV_GPU}/tensorflow_gpu-1.10*whl -U --no-deps
