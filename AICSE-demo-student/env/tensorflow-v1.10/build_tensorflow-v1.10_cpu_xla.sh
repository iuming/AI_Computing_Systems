...
export PATH_TFVENV_CPU_XLA=${WORKSPACE}/virtualenv_cpu_xla
...
echo "=== config  ============================================================="
[ ! -e ${PATH_TFVENV_CPU_XLA} ] && virtualenv --system-site-packages ${PATH_TFVENV_CPU_XLA}
source ${PATH_TFVENV_CPU_XLA}/bin/activate
...
bazel-bin/tensorflow/tools/pip_package/build_pip_package ${PATH_TFVENV_CPU_XLA}

# Upgrade the whl package
pip install ${PATH_TFVENV_CPU_XLA}/tensorflow-1.10*whl -U --no-deps
